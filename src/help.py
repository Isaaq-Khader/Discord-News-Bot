...
class Help:
    def __init__(self, attributes) -> None:
        ...
        self.prefix = BotUtil.bot_prefix
    ...
    def dice_help(self):
        ...
        message.add_field(name="**Example Usages:**", value=f"`{self.prefix}Roll 1d20`\n`{self.prefix}Roll 8d6+4`\n`{self.prefix}Roll 2d4-1`", inline=False)
        return message
    ...
    def general_help(self):
        ...
        message.add_field(name="", value=f"For more information on these commands, type `{self.prefix}help [command]`", inline=False)
        message.add_field(name="", value=f"Example: `{self.prefix}help news`", inline=False)
        return message
    ...
    def news_help(self, attributes):
        ...
        if len(attributes) == 1:
            ...
            message.add_field(name="", value=f"For more information on these commands, type `{self.prefix}help news [command]`", inline=False)
            message.add_field(name="", value=f"Example: `{self.prefix}help news please`", inline=False)
            return message
        try:
            match attributes[1]:
                case "add":
                    ...
                    message.add_field(name="**Example Usage**", value=f"`{self.prefix}news add 12345678901234567 stock market` -- adds the search term _stock market_ to daily news upload in channel _12345678901234567_.", inline=False)
                ...
                case "from":
                    ...
                    message.add_field(name="**Example Usage**", value=f"`{self.prefix}news from technology` -- searches Google News under the topic of _technology_.\n`{self.prefix}news from artificial intelligence` -- searches Google News using the search term of _artificial intelligence_.", inline=False)
                ...
                case "get":
                    ...
                    message.add_field(name="**Example Usage**", value=f"`{self.prefix}news get https://www.economist.com/business/2024/06/20/nvidia-is-now-the-worlds-most-valuable-company`", inline=False)
                ...
                case "list":
                    ...
                    message.add_field(name="**Example Usage**", value=f"`{self.prefix}news list`", inline=False)
                ...
                case "please":
                    ...
                    message.add_field(name="**Example Usage**", value=f"`{self.prefix}news please`", inline=False)
                ...
                case "remove":
                    ...
                    message.add_field(name="**Description**", value=f"Removes a search term from being summarized in the daily news from the specified channel. If you're unsure of what topics already exist, use `{self.prefix}news list` in the channel.", inline=False)
                    message.add_field(name="**Example Usage**", value=f"`{self.prefix}news remove 12345678901234567 stock market` -- will no longer search news about the _stock market_ daily in channel _12345678901234567_.", inline=False)
